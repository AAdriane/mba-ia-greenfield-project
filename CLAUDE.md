...
- `next-frontend/` — Frontend (Next.js). Phases 01-02 delivered (auth, users, channels). The video UI is not part of Phase 03.
...
- **Message Queue** (BullMQ on Redis) → video processing job queue (`video-processing`)
